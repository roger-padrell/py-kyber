...
function createKyberFrom(publicTable, signalSecret, noiseSecret){
...
function createRandomKyber(){
  var k = createKyberFrom(generatePublicTable(), generateSignalSecret(), generateNoiseSecret());
  return k;
}

function createMessageSender(publicTable, reciverPublicKeys){
...
function sendMessage(k, message) {
